...
public class OnTestClickListener implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        new Task().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, str);
    }
    ...
    private class Task extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            String clickId = params[0];
            if(clickId.equals(String.valueOf(R.id.button3))){
                if (testInsert()) {
            ...
            //LDump Clicked
            if(clickId.equals(String.valueOf(R.id.button1))){
            ...
            //GDump clicked
            if(clickId.equals(String.valueOf(R.id.button2))){
                Cursor resultCursor =
                        mContentResolver.query(mUri, null, "*", null, null);
